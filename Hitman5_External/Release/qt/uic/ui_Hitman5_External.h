...
public:
    ...
    QCheckBox *InfiniteHealth_checkBox;
    QCheckBox *UnlimitedBullets_checkBox;
    QCheckBox *NoSpread_checkBox;
    QCheckBox *NoRecoil_checkBox;
    QCheckBox *NonStopShooting_checkBox;
...
"   "));
        ...
        InfiniteHealth_checkBox = new QCheckBox(centralWidget);
        InfiniteHealth_checkBox->setObjectName(QString::fromUtf8("InfiniteHealth_checkBox"));
        InfiniteHealth_checkBox->setFont(font);

        verticalLayout->addWidget(InfiniteHealth_checkBox);

        UnlimitedBullets_checkBox = new QCheckBox(centralWidget);
        UnlimitedBullets_checkBox->setObjectName(QString::fromUtf8("UnlimitedBullets_checkBox"));
        UnlimitedBullets_checkBox->setFont(font);

        verticalLayout->addWidget(UnlimitedBullets_checkBox);

        NoSpread_checkBox = new QCheckBox(centralWidget);
        NoSpread_checkBox->setObjectName(QString::fromUtf8("NoSpread_checkBox"));
        NoSpread_checkBox->setFont(font);

        verticalLayout->addWidget(NoSpread_checkBox);

        NoRecoil_checkBox = new QCheckBox(centralWidget);
        NoRecoil_checkBox->setObjectName(QString::fromUtf8("NoRecoil_checkBox"));
        NoRecoil_checkBox->setFont(font);

        verticalLayout->addWidget(NoRecoil_checkBox);

        NonStopShooting_checkBox = new QCheckBox(centralWidget);
        NonStopShooting_checkBox->setObjectName(QString::fromUtf8("NonStopShooting_checkBox"));
        NonStopShooting_checkBox->setFont(font);

        verticalLayout->addWidget(NonStopShooting_checkBox);
    ...
    void retranslateUi(QMainWindow *Hitman5_ExternalClass)
    {
        ...
        InfiniteHealth_checkBox->setText(QCoreApplication::translate("Hitman5_ExternalClass", "Infinite Health", nullptr));
        UnlimitedBullets_checkBox->setText(QCoreApplication::translate("Hitman5_ExternalClass", "Unlimited Bullets", nullptr));
        NoSpread_checkBox->setText(QCoreApplication::translate("Hitman5_ExternalClass", "No Spread", nullptr));
        NoRecoil_checkBox->setText(QCoreApplication::translate("Hitman5_ExternalClass", "No Recoil", nullptr));
        NonStopShooting_checkBox->setText(QCoreApplication::translate("Hitman5_ExternalClass", "Non-stop shooting", nullptr));
    } // retranslateUi
